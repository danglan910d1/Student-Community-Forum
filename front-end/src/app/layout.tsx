...
export default function RootLayout({
  ...
  return (
    ...
    <html lang="en" className={`${roboto.variable} ${stackSansHeadline.variable}`}>
      
        <body>
          <QueryProvider> {/* QueryProvider phải bọc nội dung bên trong HTML */}
