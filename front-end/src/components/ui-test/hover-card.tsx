...
>(({ className, align = "center", sideOffset = 4, ...props }, ref) => (
  <HoverCardPrimitive.Portal>
    <HoverCardPrimitive.Content
      ...
      className={cn(
        "bg-popover text-popover-foreground z-50 w-64 rounded-md border p-4 shadow-md outline-hidden origin-(--radix-hover-card-content-transform-origin)",
...
// --- Tinh chỉnh các thành phần layout bổ sung ---
...
>(({ className, ...props }, ref) => (
  <h3
    ...
    className={cn("text-sm font-semibold leading-none tabular-nums", className)}
    {...props}
  />
));
