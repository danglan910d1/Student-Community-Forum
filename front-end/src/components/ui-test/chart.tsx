        ...
        <div className="grid gap-1.5">
          {payload
            ...
            .map((item, index) => {
              ...
              // Safe access payload fill without any
              const payloadData = item.payload as
                | Record<string, unknown>
                | undefined;
              const indicatorColor =
                color || (payloadData?.fill as string) || item.color;
...
// Tuyệt đối không dùng any. Sử dụng Record<string, unknown> để ép kiểu an toàn.
function getPayloadConfigFromPayload(
  ...
  // Sử dụng Record thay cho any để truy cập thuộc tính động
