...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.SubContent
    ...
    className={cn(
      "bg-popover text-popover-foreground z-50 min-w-[8rem] overflow-hidden rounded-md border p-1 shadow-lg origin-(--radix-menubar-content-transform-origin)",
  ...
  (
    ...
    <MenubarPrimitive.Portal>
      <MenubarPrimitive.Content
        ...
        className={cn(
          "bg-popover text-popover-foreground z-50 min-w-[12rem] overflow-hidden rounded-md border p-1 shadow-md origin-(--radix-menubar-content-transform-origin)",
